...
\begin{itemize}
  ...
  %% documentation
  \item Crafted documentation to onboard internal users on SDK API usage. Reduced helpdesk tickets handled by engineers, allowing them to focus on programming.
\end{itemize}
