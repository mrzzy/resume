...
% Summary
% passion
Undergraduate (1st Year) Computer Science with a deep passion for building data systems at scale.
...
\begin{itemize}
    ...
    %% documentation
    \item Eased adaptation of new authentication feature for clients by writing documentation. Reduced support workload for core engineers on the team.
\end{itemize}
...
\begin{itemize}
  ...
  % data quality
  \item Enforced data quality by performing data quality checks with DBT tests. Quality assurance provided confidence in metrics computed on the data.
\end{itemize}
...
\begin{itemize}
  %% data profiling
  \item Performed Exploratory Data Analysis with Pandas to profile Yelp Dataset for Data Science project. Insights were instrumental to feature engineering in for ML modeling.
  %% data processing
...
\section{Skills}
\begin{itemize}
  \item Python, SQL, Java, JavaScript, TypeScript, Golang, Cloud Computing, GCP, AWS, Terraform, Docker, Ansible, Packer, Kubernetes, CI/CD, Github Actions, Redis, PostgreSQL, Grafana, DBT, Pandas, Linux, Spark
