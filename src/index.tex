...
\begin{itemize}
  \item Automated manual with engineering Extract Load Transform (ETL) data pipeline with with Python, SQL, DBT \& AWS Redshift Data Warehouse orchestrated with Apache Airflow to import \& transform bank transactions from accounting system. Improved data quality by avoiding data entry errors.
