...
\begin{itemize}
  \item Supported programming contest with over 40 participants by deploying multi microservice online judge used to evaluate participant solutions on AWS with Kubernetes \& Docker.
...
\begin{itemize}
  \item Architected end to end ELT data pipeline with built with AWS S3 data lake, AWS Redshift Data Warehouse, Apache Airflow ochestration and Apache Superset Visualisation layer. Designed dimensional data model for Data Warehouse.
  \item Built data pipeline with Python, SQL, Pandas, DBT. Improved data quality by avoiding data entry errors.
...
\begin{itemize}
  \item Designed \& built Google Cloud (GCP) hosted Linux coding environment accessible on any device with Cloudfare DNS, Terraform,
...
\begin{itemize}
    \item Resolved production issue causing system downtime by patching Protobuf data schema. Service degradation affected a critical downstream system.
    \item 
        Designed \& implemented a analytics dashboard with Grafana, GCP BigQuery and SQL. Assisted management in making informed decisions during project planning.
...
\section{Skills}
\begin{itemize}
  \item Python, SQL, Java, JavaScript, TypeScript, Golang, Cloud Computing, GCP, AWS, Terraform, Docker, Ansible, Packer, Kubernetes, CI/CD, Github Actions, Redis, PostgreSQL, Grafana, DBT, Pandas, Linux, gRPC, Protobuf
