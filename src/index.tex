...
\begin{itemize}
    ...
    \item Wrote authentication support for SDKs relied on by internal clients in Golang \& Java for enhanced data security. Eased adaptation of authentication for clients by writing documentation.
\end{itemize}
