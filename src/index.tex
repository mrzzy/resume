...
\begin{itemize}
    \item Wrote JSON audit logging system that sank system activity traces into BigQuery for later analysis.
    \item 
        Designed \& implemented a analytics dashboard with Grafana, Google Cloud (GCP) BigQuery and SQL using JSON Audit Log. Assisted management in making informed decisions during project planning.
