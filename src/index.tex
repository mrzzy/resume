...
\begin{itemize}
  \item Automated manual accounting a with a ELT data pipeline built with DBT \& AWS Redshift Data Warehouse to import bank transactions into accounting system. Improved data quality by avoiding data entry errors.
...
\section{Skills}
\begin{itemize}
  \item Python, SQL, Java, JavaScript, TypeScript, Golang, GCP, AWS, Terraform, Docker, Ansible, Packer, Kubernetes, CI/CD, Redis, PostgreSQL, Grafana, DBT
